 ...
 * @author Akr-Taku
 */
public class VeiculoTable  extends AbstractTableModel {
    
    private final List<String[]> linhas;
    //Declara o nome das Colunas da Tabela
    private final String[] colunas = {" # ","Placa","Modelo","Chassi","Ano","Marca","Portas","Cor","Status","Categoria"};
    ...
    public VeiculoTable(List<String[]> lista){       
    ...
    public Object getValueAt(int linha, int coluna) { 
        ...
        switch (coluna){
            ...
            case 1:
                return temp[1];//Retorna o Placa
            case 2:
                return temp[2];//Retorna o Modelo
            case 3:
                return temp[3];//Retorna o Chassi
            case 4:
                return temp[4];//Retorna o Ano
            case 5:
                return temp[5];//Retorna o Marca
            case 6:
                return temp[6];//Retorna o Numero de Portas
            case 7:
                return temp[7];//Retorna a Cor
            case 8: 
                return temp[8];//Retorna o Status
            case 9:
                return temp[9];//Retorna o Nome da Categoria
        }
        return null;
    }
    ...
    public String[] getVeiculo(int linha){     
    ...
    public void addLista(List<String[]> veic){
