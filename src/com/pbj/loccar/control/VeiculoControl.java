...
public class VeiculoControl {
     ...
     */
    public static void salvarVeiculo(String placa, String modelo, String chassi, int ano, String marca, int numPortas, String cor, String NomeCategoria) throws SQLException {
     ...
     */
    public static List<String[]> lerVeiculo(boolean alugado) throws SQLException {
    ...
    public static List<String[]> lerVeiculo(String modelo, boolean alugado) throws SQLException {
    ...
    public static List<String[]> lerVeiculo(String modelo) throws SQLException {
    ...
    public static List<String[]> lerVeiculo(int ano, boolean alugado) throws SQLException {
    ...
    public static List<String[]> lerVeiculo(int ano) throws SQLException {
    ...
    public static List<String[]> lerVeiculo() throws SQLException {
    ...
    public static List<String> returnVeiculoID() throws SQLException {
    ...
    public static String[] pegaVeiculo(int id) throws SQLException {
    ...
    public static void atualizarVeiculo(int id, String placa, String modelo, String chassi, int ano, String marca, int numPortas, String cor, String Categoria) throws SQLException {
    ...
    public static void atualizarVeiculo(int id, boolean alugado) throws SQLException {
