...
public class UsuarioControl {
    ...
    public static void salvarUsuario(String login, String nome, String senha, String acesso) throws SQLException {
    ...
    4 = Senha
     */
    public static List<String[]> lerUsuario() throws SQLException {
    ...
    public static String[] logarUsuario(String login, String senha) throws SQLException {
    ...
    public static void atualizarUsuario(int id, String login, String nome, String senha, String acesso) throws SQLException {
    ...
    public static void apagarUsuario(int id) throws SQLException {
